/*! nouislider - 14.5.0 - 5/11/2020 */ ! function(t) {
    ...
    function z(t, v, o) {
        ...
        function R(t) {
            ...
            var m, g, v, x, e, r, b, S, w, n = t.mode,
                ...
                a = (m = i, g = n, v = s, x = {}, e = y.xVal[0], r = y.xVal[y.xVal.length - 1], S = b = !1, w = 0, (v = v.slice().sort(function(t, e) {
                    return t - e
                }).filter(function(t) {
                    return !this[t] && (this[t] = !0)
                }, {}))[0] !== e && (v.unshift(e), b = !0), v[v.length - 1] !== r && (v.push(r), S = !0), v.forEach(function(t, e) {
        ...
        function q(t) {
            var e, r, n, i, o, s, a = 100 * (t - (e = l, r = v.ort, n = e.getBoundingClientRect(), i = e.ownerDocument, o = i.documentElement, s = gt(i), /webkit.*Chrome.*Mobile/i.test(navigator.userAgent) && (s.x = 0), r ? n.top + s.y - o.clientTop : n.left + s.x - o.clientLeft)) / T();
        ...
        function I(t, e) {
            ...
            n.push.apply(n, i.concat(o, s)), t.cursor && (C.style.cursor = getComputedStyle(t.target).cursor, 1 < u.length && ht(h, v.cssClasses.drag), C.addEventListener("selectstart", ct, !1)), e.handleNumbers.forEach(function(t) {
                J("start", t)
            })
        }
        function n(t) {
        ...
        function it(t, e) {
            return null === t || !1 === t || void 0 === t ? b[e] : ("number" == typeof t && (t = String(t)), t = v.format.from(t), !1 === (t = y.toStepping(t)) || isNaN(t) ? b[e] : t)
        }
        function ot(t, e) {
            var r = dt(t),
                n = void 0 === b[0];
        ...
        return ht(e = h, v.cssClasses.target), 0 === v.dir ? ht(e, v.cssClasses.ltr) : ht(e, v.cssClasses.rtl), 0 === v.ort ? ht(e, v.cssClasses.horizontal) : ht(e, v.cssClasses.vertical), ht(e, "rtl" === getComputedStyle(e).direction ? v.cssClasses.textDirectionRtl : v.cssClasses.textDirectionLtr), l = k(e, v.cssClasses.base),
            function(t, e) {
                ...
                updateOptions: function(e, t) {
                    ...
                    n.forEach(function(t) {
                        void 0 !== e[t] && (v[t] = i[t])
                    }), y = i.spectrum, v.margin = i.margin, v.limit = i.limit, v.padding = i.padding, v.pips ? R(v.pips) : F(), v.tooltips ? H() : z(), b = [], ot(e.start || r, t)
                },
                target: h,
                removePips: F,
                removeTooltips: z,
